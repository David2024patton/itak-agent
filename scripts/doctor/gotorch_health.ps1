# GOTorch Health Check Script (Doctor Agent)
# Purpose: Verify GOTorch server is functional without triggering Windows Firewall.
...
Write-Host "GOTorch Health Check - $baseUrl" -ForegroundColor Cyan
Write-Host "---"
